...
import end_to_end_testing.BaseTest;  // Base class for shared WebDriver setup
import end_to_end_testing.DataProviders;  // DataProvider class for test data
import org.testng.annotations.Test;  // TestNG annotation
import pages.HomePage;  // Page Object for Home Page
